...
class CloudSystem extends ParticleSystem {
  ...
  static desc = "Condenses from a bunch of small balls into a big fluffy cloud and then slowly returns to ball form densely"; // Ignore the Glitch parse error

  constructor() {
    // Make what particle, and how many?
    // Try different numbers of particles
    super(CloudParticle, 150);
  }

  draw(p) {
    // A little bit of trails!
    p.background(0, 0, 50, 1000);
